...
export const getLottoColor = (num: number) => {
  if (num <= 10) return { bg: '#f59e0b', border: '#d97706', text: '#ffffff' }; // 1~10 노랑
  if (num <= 20) return { bg: '#2563eb', border: '#1d4ed8', text: '#ffffff' }; // 11~20 파랑
  if (num <= 30) return { bg: '#dc2626', border: '#b91c1c', text: '#ffffff' }; // 21~30 빨강
  if (num <= 40) return { bg: '#4b5563', border: '#374151', text: '#ffffff' }; // 31~40 회색
  return { bg: '#16a34a', border: '#15803d', text: '#ffffff' }; // 41~45 초록
};
